...
<script>
  ...
  export default {
    ...
    data: function () {
      return {
        link: '',
        blogtitle: '3 Jahre später – Wo bleibt das Versprechen einer Transformation?',
        publishingdate: '25. September 2018'
      }
    },
    mounted: function () {
